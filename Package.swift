    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                .target(name: "TreeSitterPlain"),
                .target(name: "TreeSitterPlainQueries"),
        ...
        .target(name: "TreeSitterPlain", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterPlainQueries", resources: [.copy("highlights.scm")]),
